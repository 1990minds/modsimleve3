...
const expairy = moment(user?.license?.expiry_date).format("YYYY-MM-DD")
const current = moment().format("YYYY-MM-DD")
var days = moment(expairy).diff(current, 'days');
...
<div className='btn-sign-in ' style={{ color: '#1890FF',  fontSize:'bold'  }} >

<span  className=''>License Expiry : <span style={{color:'#E83F36'}}>{days} days</span></span>
